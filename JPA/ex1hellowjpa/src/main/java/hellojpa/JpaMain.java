...
public class JpaMain {
    ...
    public static String insert(EntityManager em){
    ...
    public static String update(EntityManager em){
    ...
    public static String delete(EntityManager em){
    ...
    public static String jpql(EntityManager em){
