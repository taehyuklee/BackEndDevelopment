...
public class PartitionService {
    ...
    public void createTraffic(){
        ...
        String statement = "create table public.\"TRAFFIC\" (id bigint, startTime timeStamp, endTime timeStamp, contents varchar(50)) partition by range (endtime)";
    ...
    public void deleteTraffic(){
        ...
        String statement = "drop table public.\"TRAFFIC\"";
    ...
    public void partitionTraffic(){
        ...
        String partitionName = PartitionUtility.getPartitionName(currentDate);
    ...
    public void deletePartition(){
        ...
        String statement = "drop table if exists public.\"TRAFFIC_집에 가고싶다\"";
